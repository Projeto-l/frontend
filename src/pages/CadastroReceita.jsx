...
import { Icon } from '../components/Icons'; // Ajustar se necessário
...
export default function CadastroReceita() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!response.ok) {
        setSubmitError(`Erro ao cadastrar a receita: ${response.status} - ${data?.message || response.statusText}`);
        return;
      }
  ...
  return (
    <div className="cadastro-page">
      <form className="card form_card prescription-container" onSubmit={handleSubmit}>
