    ...
    <div className="cadastro-page">
      <form method="post" className="card form_card" onSubmit={handleSubmit}>
        <div className="content">
          ...
          {formEntries.values.name && <label htmlFor="">Nome</label>}
          <div className="field">
            <Icon name="user"></Icon>
            <input
              disabled={props.onlyView ? true : undefined}
              type="text"
              placeholder="Nome"
              name="name"
              id="name"
              value={formEntries.values.name}
          ...
          {formEntries.values.email && <label htmlFor="">Email</label>}
          <div className="field">
          ...
          {!props.onlyView && (
            <div className="field">
              ...
              <input
                ...
                id="password"
                onChange={formEntries.handleChange}
                value={formEntries.values.password}
              />
            </div>
          )}
          {errors.telefone && (
          ...
          {formEntries.values.telefone && <label htmlFor="">Telefone</label>}
          <div className="field">
            <Icon name="tel"></Icon>
            <input
              disabled={props.onlyView ? true : undefined}
              ...
              id="telefone"
              onChange={formEntries.handleChange}
              value={formEntries.values.telefone}
            />
          </div>
          {errors.registro && (
            <div className="error">
